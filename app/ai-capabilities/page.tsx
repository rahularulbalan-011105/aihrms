    ...
    <>
      ...
      <section className="px-6 lg:px-10">
        <div className="mx-auto max-w-[1400px] grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
          <CapCard
            icon="match" tone="purple" title="AI Job Matching"
          ...
          <CapCard
            icon="parse" tone="blue" title="AI Resume Parsing"
          ...
          <CapCard
            icon="search" tone="purple" title="Semantic Search"
          ...
          <CapCard
            icon="trophy" tone="green" title="AI Candidate Ranking"
          ...
          <CapCard
            icon="screen" tone="orange" title="AI Screening & Shortlisting"
          ...
          <CapCard
            icon="shield" tone="red" title="Fake Job Detection"
          ...
          <CapCard
            icon="duplicate" tone="blue" title="Duplicate Job Detection"
          ...
          <CapCard
            icon="apply" tone="purple" title="Auto Job Apply"
          ...
          <CapCard
            icon="alert" tone="orange" title="Fake Profile Identification"
          ...
          <CapCard
            icon="analytics" tone="green" title="Hiring Analytics"
  ...
  return (
    <div className="card p-4 flex flex-col">
      <div className="flex items-start justify-between gap-2">
        <div className={`w-9 h-9 rounded-md flex items-center justify-center text-[16px] ${ICON_TONE[props.tone]}`}>
...
/* ---------------- visual mini-blocks (one per card) ---------------- */
  ...
  return (
    <div>
      ...
      <div className="mt-2 space-y-1.5 text-[11px]">
        <Row label="Total Candidates" value="320" dotColor="#94A3B8" />
        <Row label="Shortlisted"      value="48"  dotColor="#22C55E" />
        <Row label="Rejected"         value="272" dotColor="#EF4444" />
      </div>
    </div>
  );
}
...
function RiskWarn() {
  return (
    <div className="rounded-md border border-red-200 bg-red-50 px-3 py-2.5">
      <div className="text-[11px] font-bold text-red-700 flex items-center gap-1.5">⚠ Risk Level: High</div>
  ...
  return (
    <div>
      ...
      <div className="mt-2 flex items-center gap-1.5 text-ink-400">
        {[0,1,2,3].map(i => (
          <span key={i} className="text-[14px]">📄{i < 3 && <span className="text-ink-300 mx-0.5">›</span>}</span>
        ))}
      </div>
    </div>
  );
