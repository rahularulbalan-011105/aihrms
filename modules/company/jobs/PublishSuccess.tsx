  ...
  return (
    <div className="px-6 lg:px-8 py-6 max-w-[1400px] mx-auto">
      ...
      <div className="flex items-start justify-between gap-4 mb-5">
        <Link href="/company/jobs/new" className="px-3.5 py-2 rounded-lg border border-brand-300 text-brand-700 text-[12.5px] font-semibold hover:bg-brand-50 transition inline-flex items-center gap-1.5">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <button className="px-4 py-2.5 rounded-lg text-white text-[13px] font-semibold inline-flex items-center gap-2" style={{ background: "var(--gradient-brand)" }}>
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white border border-ink-100 rounded-xl px-6 py-7 flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="flex-1 text-center md:text-left">
              <h1 className="font-display text-[24px] font-extrabold inline-flex items-center gap-2">
          ...
          <div className="bg-white border border-ink-100 rounded-xl p-5">
            ...
            <div className="grid grid-cols-[88px_1fr] gap-4 items-start">
              ...
              <div>
                <div className="font-display text-[17px] font-extrabold">Senior Software Engineer</div>
                <div className="flex items-center gap-3 text-[12px] text-ink-600 mt-1 flex-wrap">
                  <span className="inline-flex items-center gap-1"><BuildingIcon /> Acme Talent Solutions</span>
                  <span aria-hidden="true">•</span>
                  <span className="inline-flex items-center gap-1"><PinIcon /> Bengaluru, Karnataka, India (Hybrid)</span>
                  <span aria-hidden="true">•</span>
                  <span className="inline-flex items-center gap-1"><BriefIcon /> Full-time</span>
                  <span aria-hidden="true">•</span>
                  <span className="inline-flex items-center gap-1"><UserIcon /> Opening</span>
                </div>
                <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-y-3 gap-x-8 pt-3 border-t border-ink-100">
                  ...
                  <Detail label="Salary Range" value="₹ 12,00,000 – ₹ 18,00,000 per annum" />
                  <Detail label="Role / Category" value="Software Development" />
                ...
                <a className="mt-3 inline-flex items-center gap-1 text-[12.5px] text-brand-700 font-semibold">View Full Job Details <ArrowRight /></a>
              </div>
            </div>
          </div>
        ...
        <aside className="flex flex-col gap-3">
          ...
          <div className="rounded-xl border border-ink-100 p-4 bg-white">
            ...
            <ul className="space-y-1.5 text-[12.5px] text-ink-700">
              <li className="flex items-center gap-2"><span className="text-green-600">✓</span> AI HRMS Job Board</li>
...
function NextCard({ icon, title, body, action, tint }: { icon: React.ReactNode; title: string; body: string; action: string; tint: string }) {
  return (
    <div className="bg-white border border-ink-100 rounded-xl p-4">
      ...
      <a className="text-[12.5px] text-brand-700 font-semibold inline-flex items-center gap-1">{action} <ArrowRight /></a>
    </div>
  );
}
...
function Social({ icon, label, bg }: { icon: string; label: string; bg: string }) {
  return (
  ...
  return (
    <div className="relative w-[140px] h-[140px] shrink-0">
      <svg viewBox="0 0 140 140" width="140" height="140" fill="none">
        ...
        <path d="M53 71l12 12 24-26" stroke="white" strokeWidth="6" strokeLinecap="round" strokeLinejoin="round"/>
        ...
        <path d="M30 40l-4-3M110 38l3-2M30 100l-4 3M115 95l3 2" stroke="#F59E0B" strokeWidth="2" strokeLinecap="round"/>
        <path d="M14 65l-3-1M127 80l3 1M70 16l1-4M70 124l1 3" stroke="#A78BFA" strokeWidth="2" strokeLinecap="round"/>
      </svg>
    </div>
  );
}
...
function ShortlistIcon() { return (<svg width="16" height="16" viewBox="0 0 24 24" fill="none"><rect x="4" y="3" width="16" height="18" rx="2" stroke="currentColor" strokeWidth="1.6"/><path d="M8 9h8M8 13h8M8 17h5" stroke="currentColor" strokeWidth="1.6" strokeLinecap="round"/></svg>); }
function ShareIcon() { return (<svg width="14" height="14" viewBox="0 0 24 24" fill="none"><circle cx="6" cy="12" r="3" stroke="currentColor" strokeWidth="1.6"/><circle cx="18" cy="5" r="3" stroke="currentColor" strokeWidth="1.6"/><circle cx="18" cy="19" r="3" stroke="currentColor" strokeWidth="1.6"/><path d="M9 11l6-4M9 13l6 4" stroke="currentColor" strokeWidth="1.6"/></svg>); }
function ShieldIcon() { return (<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><path d="M12 3l8 4v6c0 4-3 7-8 8-5-1-8-4-8-8V7l8-4z" stroke="currentColor" strokeWidth="1.6"/></svg>); }
...
function GlobeIcon() { return (<svg width="14" height="14" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="9" stroke="currentColor" strokeWidth="1.6"/><path d="M3 12h18M12 3a14 14 0 0 1 0 18M12 3a14 14 0 0 0 0 18" stroke="currentColor" strokeWidth="1.6"/></svg>); }
...
function MailIcon() { return (<svg width="18" height="18" viewBox="0 0 24 24" fill="none"><rect x="3" y="5" width="18" height="14" rx="2" stroke="currentColor" strokeWidth="1.6"/><path d="M3 7l9 6 9-6" stroke="currentColor" strokeWidth="1.6"/></svg>); }
