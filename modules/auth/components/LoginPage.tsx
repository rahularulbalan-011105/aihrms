    ...
    <div className="h-screen flex flex-col bg-[#f4f1ff] overflow-hidden">
      ...
      <main className="flex-1 grid lg:grid-cols-[1fr_1fr] items-stretch min-h-0">
        ...
        <div className="hidden lg:flex flex-col justify-center px-12 xl:px-20 py-2">
          <h1 className="font-display text-[34px] xl:text-[38px] font-extrabold leading-[1.15] text-ink-900 tracking-tight">
            Welcome back!
            <br />
            Let&apos;s build <span className="text-brand-600">winning</span>
            <br />
            futures together.
          </h1>
            ...
            <div className="grid grid-cols-2 gap-3 mt-4">
              {(["candidate", "recruiter"] as UserRole[]).map((r) => {
                ...
                return (
                  ...
                  >
                    <div
                      className={`w-8 h-8 rounded-lg flex items-center justify-center shrink-0 ${isCand ? "bg-brand-100 text-brand-600" : "bg-green-100 text-green-600"}`}
                    >
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <button
                    ...
                    tabIndex={-1}
                    className="absolute right-3.5 top-1/2 -translate-y-1/2 text-ink-400 hover:text-ink-600 transition p-0.5"
                  >
            ...
            <div className="grid grid-cols-4 gap-2">
              {[
                ...
                <button
                  key={s.name}
                  type="button"
                  className="flex items-center justify-center gap-1.5 py-2 px-1 rounded-xl border border-ink-200 bg-white hover:bg-ink-50 transition"
                >
                  {s.icon}
        ...
        <div className="mx-auto max-w-[1000px] px-6 py-3 grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div key={s.label} className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-full bg-brand-50 flex items-center justify-center text-[16px] shrink-0">
                {s.icon}
              </div>
              <div>
                <div className="font-display font-extrabold text-[18px] text-ink-900 leading-none">
                  {s.value}
                </div>
      ...
      <footer className="border-t border-ink-100 bg-white py-2.5 shrink-0">
        <div className="text-center text-[12.5px] text-ink-500 space-x-1">
          <span>© 2026 HireMind. All rights reserved.</span>
...
function FeatureCard({
  ...
  return (
    <div className="flex items-start gap-4 p-4 rounded-xl border border-ink-100 bg-white">
      <div
        className={`w-11 h-11 rounded-full ${iconBg} ${iconColor} flex items-center justify-center shrink-0`}
      >
        {icon}
      </div>
      <div>
...
function EyeOffIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      <path
        d="M17.94 17.94A10.07 10.07 0 0 1 12 20c-7 0-11-8-11-8a18.45 18.45 0 0 1 5.06-5.94M9.9 4.24A9.12 9.12 0 0 1 12 4c7 0 11 8 11 8a18.5 18.5 0 0 1-2.16 3.19M3 3l18 18"
        stroke="currentColor"
        strokeWidth="1.6"
        strokeLinecap="round"
      />
