      ...
      <div className="space-y-4">
        ...
        >
          ...
          <div className="grid md:grid-cols-2 gap-4">
            {/* Work Experience */}
            <div>
              <p className="text-[12.5px] font-bold text-ink-700 mb-2">
                Work Experience ({step2.experience.length || 2})
              </p>
              <ul className="space-y-1">
                {(step2.experience.length
                  ? step2.experience
                  : [
            ...
            <div>
              <p className="text-[12.5px] font-bold text-ink-700 mb-2">
                Education ({step2.education.length || 2})
              </p>
              <ul className="space-y-1">
                {(step2.education.length
                  ? step2.education
                  : [
        ...
        >
          <div className="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <div className="flex flex-wrap gap-1.5">
                {(topSkills.length
                  ...
                  <span key={name} className="px-2.5 py-1 rounded-full bg-ink-100 text-ink-700 text-[12.5px] font-semibold border border-ink-200">
                    {name}
                  </span>
                ))}
                {(extraSkills > 0 || !topSkills.length) && (
                  <span className="px-2.5 py-1 rounded-full bg-brand-50 text-brand-700 text-[12.5px] font-semibold border border-brand-200">
                    +{extraSkills || 5} more
                  </span>
                )}
              </div>
            ...
            <div>
              <p className="text-[12.5px] font-bold text-ink-700 mb-2">
                Certifications ({step3.certifications.length || 3})
              </p>
              <ul className="space-y-1">
                {(step3.certifications.length
                  ? step3.certifications
                  : [
...
/* ── Icons ── */
function PersonIcon()    { return <svg width="16" height="16" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="8" r="3.5" stroke="currentColor" strokeWidth="1.7"/><path d="M4 20c0-4 3.5-7 8-7s8 3 8 7" stroke="currentColor" strokeWidth="1.7" strokeLinecap="round"/></svg>; }
