...
const NEXT_STEPS = [
  ...
  },
  {
    ...
    desc: "Add a profile video or portfolio to stand out.",
    href: "/profile/edit",
  },
  {
    icon: <BellIcon />,
    ...
    desc: "Get notified about relevant job opportunities.",
  ...
  },
  {
    ...
    desc: "Fine-tune your preferences anytime.",
    href: "/settings",
  },
  {
    icon: <GiftIcon />,
    ...
    title: "Invite & Earn",
    desc: "Invite your friends and earn exciting rewards.",
    href: "/referral",
  },
];
...
const ENHANCEMENTS = [
  {
    ...
    desc: "Introduce yourself to recruiters with a short video.",
    cta: "Add Video",
    ctaStyle: "border-brand-400 text-brand-600 hover:bg-brand-50",
  },
  {
    icon: "📋",
    ...
    iconBg: "bg-green-50",
    title: "Add Portfolio",
    desc: "Showcase your work and projects to build credibility.",
    cta: "Add Portfolio",
    ctaStyle: "border-green-400 text-green-600 hover:bg-green-50",
  },
  {
    icon: "📄",
    ...
    iconBg: "bg-orange-50",
    title: "Upload Resume",
    desc: "Let recruiters download your resume in one click.",
    cta: "Upload Resume",
    ctaStyle: "border-orange-400 text-orange-500 hover:bg-orange-50",
  },
  {
    icon: "👥",
    color: "text-brand-600",
    iconBg: "bg-brand-50",
    title: "Get Endorsed",
    desc: "Get skill endorsements from your colleagues.",
...
export default function ProfileSubmission({ candidateName }: Props) {
  ...
  return (
    <div className="h-screen flex flex-col bg-[#F8F7FF] overflow-hidden">
      ...
      <header className="bg-white border-b border-ink-100 sticky top-0 z-20">
        <div className="mx-auto max-w-[1400px] px-6 py-3.5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-5">
            <button
              type="button"
              className="flex items-center gap-1.5 text-[13.5px] text-ink-600 hover:text-ink-900 transition"
            >
              <InfoIcon /> Need Help?
            </button>
      ...
      {/* ── Main content ── */}
      <main className="flex-1 min-h-0 overflow-y-auto py-4 px-6 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
        <div className="mx-auto max-w-[1100px]">
          ...
          <div className="bg-white rounded-2xl border border-ink-100 shadow-sm overflow-hidden mb-4">
            <div className="grid md:grid-cols-[280px_1fr_300px]">
              {/* Illustration */}
              <div className="relative border-r border-ink-100 overflow-hidden min-h-[240px]">
                {/* eslint-disable-next-line @next/next/no-img-element */}
                <img
                  src={assetPath("/images/profile-submit.png")}
                  alt="Profile submitted"
                  className="absolute inset-0 left-[3px] w-full h-full object-cover"
                />
              </div>

              {/* Success content */}
              <div className="p-6 flex flex-col justify-center">
                <div className="w-14 h-14 rounded-full bg-green-500 flex items-center justify-center mx-auto mb-4 shadow-[0_8px_24px_-8px_rgba(34,197,94,0.55)]">
                ...
                <p className="text-ink-500 text-[14px] leading-relaxed text-center max-w-[400px] mx-auto mb-4">
                  Thank you for completing your profile. Recruiters can now
                  discover you based on your skills and preferences.
                </p>
                ...
                <div className="rounded-xl border border-ink-200 p-4 max-w-[400px] mx-auto w-full">
                  ...
                  <div className="flex items-center gap-2.5 p-3 rounded-lg bg-green-50 border border-green-100">
                    <div className="w-8 h-8 rounded-full bg-green-100 text-green-600 flex items-center justify-center shrink-0">
                      ...
                      >
                        <path
                          d="M12 21s-8-4.35-8-11.5a8 8 0 0 1 16 0C20 16.65 12 21 12 21z"
                          stroke="currentColor"
                          strokeWidth="1.6"
                        />
                      </svg>
              ...
              <div className="border-l border-ink-100 p-6">
                <h3 className="font-display font-extrabold text-[16px] text-ink-900 mb-4">
                  What&apos;s Next?
                </h3>
                  ...
                  {NEXT_STEPS.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="text-[13.5px] font-semibold text-ink-900 group-hover:text-brand-600 transition">
                          {item.title}
                        </div>
          ...
          <div className="bg-white rounded-2xl border border-ink-100 shadow-sm p-4 mb-4">
            <div className="text-center mb-4">
              <h2 className="font-display font-extrabold text-[18px] text-ink-900">
                Make the most of your profile
              </h2>
              <p className="text-ink-500 text-[13.5px] mt-1">
                Enhance your profile and get better opportunities
              </p>
            </div>
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
              {ENHANCEMENTS.map((item) => (
                <div
                  key={item.title}
                  className="rounded-xl border border-ink-200 p-4 flex flex-col"
                >
                  <div
                    className={`w-11 h-11 rounded-xl ${item.iconBg} flex items-center justify-center text-[20px] mb-4`}
                  >
                    {item.icon}
                  </div>
                  <h3 className={`font-bold text-[14px] mb-1.5 ${item.color}`}>
                    {item.title}
                  </h3>
                  <p className="text-ink-500 text-[12.5px] leading-relaxed flex-1 mb-4">
                    {item.desc}
                  </p>
                  <button
                    type="button"
...
function GiftIcon() {
  return (
    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
      ...
      />
      <path
        d="M8 9c0-2 2-4 4-4s4 2 4 4M8 9C6 9 4 8 4 6s2-3 4-1c.7.7 4 4 4 4M16 9c2 0 4-1 4-3s-2-3-4-1c-.7.7-4 4-4 4"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
      />
